...
def gen_xml_v43(inv, sale_conditions, total_servicio_gravado,
    ...
    if inv.tipo_documento != 'TE' or (receiver_company.has_reference_so and inv._name != 'pos.order') or inv.invoice_id and inv.reference_code_id and inv.reference_document_id:
