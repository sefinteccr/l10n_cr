...
odoo.define('cr_electronic_invoice_pos.models', function (require) {
    ...
    models.Order = models.Order.extend({
        export_for_printing: function(){
            ...
            order.economic_activity_id = this.get_economic_activity_id();
            //debugger;
            return order;
        },
        ...
        set_economic_activity_id: function (economic_activity_id) {
            this.economic_activity_id = economic_activity_id;
        },
        get_economic_activity_id: function () {
            return this.economic_activity_id;
        },
    });
